...
const serverStatsActions = {
  suppressTop: require('../../src/stores/top-store').suppressTop,
  dbError: require('../../src/stores/dberror-store').dbError,
  pollTop: require('../../src/stores/top-store').top_delta
};

mock('../../src/actions', serverStatsActions);
